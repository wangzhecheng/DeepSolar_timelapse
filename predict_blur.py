...
old_ckpt_path = 'checkpoint/blur_detection/LR_012_HR_12_res50/blur_decay_10_lr_0.0001_wd_0.001_6_last.tar'
...
if __name__ == '__main__':
    ...
    with open(join(result_dir, 'blur_res50_LR_012_HR_12.pickle'), 'wb') as f:
